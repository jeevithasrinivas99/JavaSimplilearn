...
public class DBOperations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            out.println("welcome to dboperations");
           ...
           DBConnection conn = new DBConnection(props.getProperty("jdbc:mysql://localhost:3306/ecommerce"), props.getProperty("userid"), props.getProperty("password"));
